...
public class ScannerDiagnostics
{
	...
	public static final DiagnosticId INVALID_LITERAL_SUFFIX              = new DiagnosticId(DiagnosticKind.LEXICAL,  9, "invalid literal suffix '%s'");
	...
	public static final DiagnosticId INVALID_DIGIT_FOR_BASE              = new DiagnosticId(DiagnosticKind.LEXICAL, 12, "invalid digit for numeric literal with base %s");
	public static final DiagnosticId EMPTY_SUFFIX                        = new DiagnosticId(DiagnosticKind.LEXICAL, 13, "empty literal suffix");
}
